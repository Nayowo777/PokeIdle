...
export function backgroundCatchupSupported(platform = globalThis.__POKEIDLE_MOBILE__) {
  return platform?.isMobile === true ? false : true;
}

export function bgCatchupEnabled(platform = globalThis.__POKEIDLE_MOBILE__) {
  return BACKGROUND_CATCHUP && backgroundCatchupSupported(platform);
}
